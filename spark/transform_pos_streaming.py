...
userSchema = StructType().add("customer_id", "integer").add("restaurant_name", "str").add("customer_order", "string").add("order_timestamp", "integer").add("pos_type", "str")
...
query = strmDF \
    .selectExpr('customer_id as cust_id', 'restaurant_name as res_name','order_menu as odr_menu','order_price as odr_prc','order_timestamp as odr_tms', 'pos_type as pos_type') \
    .writeStream \
    .outputMode("append") \
    .format("parquet") \
